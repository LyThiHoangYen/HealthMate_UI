        ...
        <div className='mb-5'>
            <div className='grid grid-cols-3 gap-5 mb-[30px]'>
                ...
                <div>
                    ...
                    className='form__input py-3.5'>
                        <option value="">Select</option>
                        <option value="surgon">Male</option>
                        <option value="neruologist">Female</option>
        ...
        <div className='mb-5'>
            ...
            <div key={index}>
                <div>
                    ...
                    <button onClick={addTimeSlot} className='bg-red-600 p-2 rounded-full text-white text-[18px]
                    cursor-pointer mt-6'>
                        <AiOutlineDelete/>
                    </button>
                </div>
